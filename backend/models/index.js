...
// sequelize.sync({ alter: true }) // Use { force: true } to drop and recreate the table, .sync({ alter: true }) - This checks what is the current state of the table in the database (which columns it has, what are their data types, etc), and then performs the necessary changes in the table to make it match the model.
//   .then(() => {
...
db.Edge = require("./edge.model.js")(sequelize, DataTypes);
db.ChatRoomMessage = require("./chatRoomMessage.model.js")(sequelize, DataTypes);
db.Essay = require("./essay.model.js")(sequelize, DataTypes); // 新增 Essay 模型
